...
<div class="login-box">
  <div class="login-logo">
    <a href="/res/admin/index2.html"><b>Mystical</b>Geek</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <form action="/admin/login" method="post">
      <div class="form-group has-feedback">
        <input type="text" name="login" class="form-control" placeholder="Insira seu login">
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-4">
          <button type="submit" class="btn btn-primary btn-block btn-flat" style="background-color: #0B610B; color: #fff; border:0">Login</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
